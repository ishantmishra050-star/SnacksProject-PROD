...
To push code to these environments, use the following commands:

- **Push to UAT**: `git push uat main`
- **Push to Production**: `git push prod main`

Note: Ensure your local Git credentials are set up for the `ishantmishra050-star` account.
